...
rule qtl2_covar:
    ...
    output:
        "data/qtl2/covar.csv"
    run:
        df = pd.DataFrame(dict(id=rat_ids))
        df["generations"] = 90
...
rule run_qtl2:
    input:
        geno = "data/qtl2/geno.csv",
        founder_geno = "data/qtl2/founder_geno.csv",
        pheno = "data/qtl2/pheno.csv",
        covar = "data/qtl2/covar.csv",
        pmap = "data/qtl2/pmap.csv",
        gmap = "data/qtl2/gmap.csv",
        control = "data/qtl2/eyes.yaml",
        tss = "data/qtl2/gene_tss.tsv"
    output:
        "data/qtl2/eyes.gene_var_lod.tsv.gz"
    conda:
        "../envs/qtl2.yaml"
    threads: 8
    shell:
...
rule run_qtl2_perm:
    input:
        ...
        tss = "data/qtl2/gene_tss.tsv"
    output:
        "data/qtl2/eyes.gene_lod_perm.tsv.gz"
    conda:
        "../envs/qtl2.yaml"
    threads: 8
    resources:
...
rule run_qtl2_coef:
    input:
        ...
        tss = "data/qtl2/gene_tss.tsv"
    output:
        "data/qtl2/eyes.gene_var_coefs.tsv.gz"
    conda:
        "../envs/qtl2.yaml"
    threads: 8
    shell:
...
rule qtl2_pvals:
    input:
        pairs = "data/qtl2/eyes.gene_var_lod.tsv.gz",
        perm = "data/qtl2/eyes.gene_lod_perm.tsv.gz",
        coefs = "data/qtl2/eyes.gene_var_coefs.tsv.gz"
    output:
        "data/qtl2/eyes.gene_var_pval.tsv.gz"
    conda:
        "../envs/bioinfo.yaml"
    shell:
